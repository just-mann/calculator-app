...
// Functions for Bacsic Math Operators
    ...
    function add(a, b){
        let output = a + b;
        console.log(a + b);
        return showResult.textContent = output.parseFloat(2).toFixed(2);
    }
    ...
    function subtract(a, b){
        let output = a - b;
        console.log(a - b);
        return showResult.textContent = output.parseFloat(x2).toFixed(2);
    }
    ...
    function multiply(a, b){
        let output = a * b;
        console.log(a * b);
        return showResult.textContent = output.parseFloat(x).toFixed(2);
    }
