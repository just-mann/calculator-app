...
function evaluate() {
    ...
    if (currentOperation === '/' && showResult.in === '0') {
        alert('Cannot divide by zero');
        // clearField() 
        return;
    }
    secondOperand = showResult.in;
    showResult.in = operate(currentOperation, firstOperand, secondOperand);
